...
def makeRDF(pdbdir, side, numbins, cm=False, numAT=0):
    ...
    for pdb in pdbs:
        ...
        atoms = []
        cmm = [9.304,9.304,9.304] # center of mass of molecule
        atc = 1 # atom counter
...
numAT = 688 # number of atoms in molecule
pdbsdir = "/home/kenneth/proj/proMin/minerals/rdf" # directory with PDB files
outfile = path.join(pdbsdir,"rdf.out")
