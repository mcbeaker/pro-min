...
vp = sb.violinplot(data=df.loc[df.Bond_Valence_Sum <=4], x='Element', y = 'Bond_Valence_Sum', hue='Type',split=True)
vp.set(ylabel='Bond Valence Sum')
plt.tight_layout()
# plt.show()
plt.savefig(os.path.join(out,'060121-vp_rmOut_min_pro_val.png'),dpi=400)
